...
public class SmartIdAuthenticationService {
    ...
    public AuthenticationIdentity authenticate(HttpSession session) {
        ...
        if (deviceLinkSessionInfo != null) {
            ...
            authenticationIdentity = deviceLinkAuthenticationResponseValidator.validate(deviceLinkSessionInfo.getSessionStatus(), deviceLinkSessionInfo.getRequest(), "smart-id-demo");
        }
